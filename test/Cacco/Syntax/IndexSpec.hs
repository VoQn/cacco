...
scprop_ExprProxy_instance_of_Show :: Monad m =>
    IndexProxy 'Expr -> IndexProxy 'Expr -> Property m
scprop_ExprProxy_instance_of_Show a b = a == b ==> show [a] == show [b]

scprop_DeclProxy_instance_of_Show :: Monad m =>
    IndexProxy 'Decl -> IndexProxy 'Decl -> Property m
scprop_DeclProxy_instance_of_Show a b = a == b ==> show [a] == show [b]

scprop_PattProxy_instance_of_Show :: Monad m =>
    IndexProxy 'Patt -> IndexProxy 'Patt -> Property m
scprop_PattProxy_instance_of_Show a b = a == b ==> show [a] == show [b]

scprop_TypeProxy_instance_of_Show :: Monad m =>
    IndexProxy 'Type -> IndexProxy 'Type -> Property m
